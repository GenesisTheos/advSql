...
VALUES
-- Sirloin Steak (DishID 11 - Location 1)
(11, 1, 280, 'grams'),
(11, 63, 30, 'grams'),
(11, 33, 2, 'cloves'),
(11, 86, 5, 'grams'),
...
-- Sirloin Steak (DishID 60 - Location 2)
(60, 1, 280, 'grams'),
(60, 63, 30, 'grams'),
(60, 33, 2, 'cloves'),
(60, 86, 5, 'grams'),
...
-- Ribeye Steak (DishID 12 - Location 1)
(12, 2, 340, 'grams'),
(12, 63, 30, 'grams'),
(12, 33, 2, 'cloves'),
(12, 86, 5, 'grams'),
...
-- Beef Burger (DishID 13 - Location 1)
(13, 3, 200, 'grams'),
(13, 82, 1, 'whole'),
(13, 65, 40, 'grams'),
(13, 116, 20, 'grams'),
...
-- Beef Burger (DishID 62 - Location 2)
(62, 3, 200, 'grams'),
(62, 82, 1, 'whole'),
(62, 65, 40, 'grams'),
(62, 116, 20, 'grams'),
...
-- Slow Braised Beef Short Rib (DishID 14 - Location 1)
(14, 4, 400, 'grams'),
(14, 130, 100, 'ml'),
(14, 126, 200, 'ml'),
(14, 33, 3, 'cloves'),
...
-- Roast Half Chicken (DishID 16 - Location 1)
(16, 7, 400, 'grams'),
(16, 63, 40, 'grams'),
(16, 33, 3, 'cloves'),
(16, 86, 5, 'grams'),
...
-- Roast Half Chicken (DishID 65 - Location 2)
(65, 7, 400, 'grams'),
(65, 63, 40, 'grams'),
(65, 33, 3, 'cloves'),
(65, 86, 5, 'grams'),
...
-- Duck Confit (DishID 19 - Location 1)
(19, 11, 2, 'whole'),
(19, 33, 3, 'cloves'),
(19, 86, 5, 'grams'),
(19, 92, 10, 'grams'),
...
-- Grilled Salmon (DishID 32 - Location 1)
(32, 25, 200, 'grams'),
(32, 63, 30, 'grams'),
(32, 88, 5, 'grams'),
(32, 146, 1, 'whole'),
...
-- Grilled Salmon (DishID 81 - Location 2)
(81, 25, 200, 'grams'),
(81, 63, 30, 'grams'),
(81, 88, 5, 'grams'),
(81, 146, 1, 'whole'),
...
-- Lamb Shank (DishID 99 - Location 1)
(99, 22, 1, 'whole'),
(99, 130, 150, 'ml'),
(99, 126, 200, 'ml'),
(99, 33, 3, 'cloves'),
...
-- Fillet Steak (DishID 61 - Location 2)
(61, 6, 225, 'grams'),
(61, 63, 30, 'grams'),
(61, 33, 2, 'cloves'),
(61, 89, 5, 'grams'),
...
-- Slow Braised Beef Cheek (DishID 63 - Location 2)
(63, 5, 350, 'grams'),
(63, 130, 150, 'ml'),
(63, 126, 200, 'ml'),
(63, 33, 3, 'cloves'),
...
-- Duck Breast (DishID 68 - Location 2)
(68, 12, 200, 'grams'),
(68, 51, 150, 'grams'),
(68, 50, 100, 'grams'),
(68, 151, 60, 'grams'),
...
-- Pork Rack (DishID 78 - Location 2)
(78, 16, 400, 'grams'),
(78, 124, 50, 'grams'),
(78, 33, 3, 'cloves'),
(78, 87, 5, 'grams'),
...
-- Seafood Platter (DishID 100 - Location 2)
(100, 26, 100, 'grams'),
(100, 31, 6, 'whole'),
(100, 32, 6, 'whole'),
(100, 80, 2, 'slices'),
